...
API_EXPORT(PRInt64) ap_get_total_bytes();
...
API_EXPORT(pool *) ap_make_sub_pool_real(pool *, int); /* °´Ðè·ÖÅä pool */
 ...
 */
char *ap_array_pstrcat(pool *p, const array_header *arr,
                                    const char sep);
